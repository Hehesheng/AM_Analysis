...
__attribute__((weak)) void ad9959_pins_init(void)
{
    ...
    HAL_GPIO_WritePin(
        GPIOF,
        AD9959_RST_Pin | AD9959_UPDATE_Pin | AD9959_CS_Pin | AD9959_SCK_Pin | AD9959_SDIO_Pin,
        GPIO_PIN_RESET);
...
__attribute__((unused)) static uint8_t FR2_DATA[2] = {0x00, 0x00};  // default Value = 0x0000

__attribute__((unused)) static uint8_t CFR_DATA[3] = {0x00, 0x03,
                                                      0x02};  // default Value = 0x000302

// default Value = 0x0000   @ = POW/2^14*360
static uint8_t CPOW0_DATA[2] = {0x00, 0x00};

__attribute__((unused)) static uint8_t LSRR_DATA[2] = {0x00, 0x00};  // default Value = 0x----

__attribute__((unused)) static uint8_t RDW_DATA[4] = {0x00, 0x00, 0x00,
                                                      0x00};  // default Value = 0x--------

__attribute__((unused)) static uint8_t FDW_DATA[4] = {0x00, 0x00, 0x00,
                                                      0x00};  // default Value = 0x--------
